...
UIScrollViewDelegate{
    ...
    @IBOutlet var Cropview: CropAreaView!
    ...
    override func viewDidLoad() {
       ...
       // self.previewImage.contentMode = .scaleAspectFill
        ...
        {
            let alertController = UIAlertController(title: " camera not available", message: "source unavilable", preferredStyle: .alert)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
       ...
       self.previewImage.image = image
        imagee = previewImage.image!
        self.previewedThumbnailData = CIImage(cgImage: imagee.cgImage!)
    ...
    var cropArea:CGRect{
        get{
            ...
            let x = (scrollview.contentOffset.x + Cropview.frame.origin.x - imageFrame.origin.x) * scale * factor
            let y = (scrollview.contentOffset.y + Cropview.frame.origin.y - imageFrame.origin.y) * scale * factor
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let img : UIImage? = previewImage.image
        if img == nil
        {
            let alertController = UIAlertController(title: " No image Found", message: "select or click image", preferredStyle: .alert)
            let defaultAction = UIAlertAction(title: "Ok", style: .cancel, handler: nil)
            alertController.addAction(defaultAction)
            present(alertController, animated: true, completion: nil)
        }
    ...
    func collectionView(
        ...
        guard let cell: Galleryimages = collectionView.dequeueReusableCell(
            withReuseIdentifier: "galleryImages", for: indexPath) as? Galleryimages
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if previewImage != nil {
            let cell = collectionView.cellForItem(at: indexPath) as! Galleryimages
